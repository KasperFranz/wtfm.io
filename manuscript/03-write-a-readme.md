...
While the README file's purpose hasn't changed much in the past four decades, its standard format has undergone a dramatic transition over the last ten years thanks in large part to GitHub's decision to render README files according to their file extension<sup>[2](#sources)</sup>. Originally launched in 2008 with `.markdown`, `.textile`, and `.rdoc` support, GitHub's README rendering has come a long way since then, adding another six markups and countless post-processing features like emoji suppport, caching, and more. While GitHub's markup renderer supports a number of different languages, the most popular one — and my personal favorite — is Markdown.
...
[![](https://rawgit.com/zachflower/wtfm.io/master/manuscript/assets/02/badge-build-passing.svg)]() [![](https://rawgit.com/zachflower/wtfm.io/master/manuscript/assets/02/badge-coverage.svg)]() [![](https://rawgit.com/zachflower/wtfm.io/master/manuscript/assets/02/badge-downloads.svg)]() [![](https://rawgit.com/zachflower/wtfm.io/master/manuscript/assets/02/badge-license-mit.svg)]()
